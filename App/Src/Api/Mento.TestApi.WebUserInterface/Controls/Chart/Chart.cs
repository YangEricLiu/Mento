...
namespace Mento.TestApi.WebUserInterface.Controls
{
    public class Chart : JazzControl
    {
        ...
        private static Locator CurveLocator = new Locator("g.highcharts-markers", ByType.CssSelector);
        private static Locator PieLocator = new Locator("//div[contains(@id, 'piechartcomponent')]", ByType.XPath);
