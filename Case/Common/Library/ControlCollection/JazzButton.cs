...
namespace Mento.TestApi.WebUserInterface.ControlCollection
{
    public sealed class JazzButton : JazzControlCollection
    {
        ...
        //level 3
        //--Platform
        public static Button NavigatorPlatformWorkdayButton = GetControl<Button>(JazzControlLocatorKey.ButtonNavigatorPlatformWorkday);//{NavigationTarget.PlatformWorkday, new NavigatorItem(NavigationTarget.PlatformWorkday,NavigationTarget.PlatformSettings,"st-menu-workday-btnEl",ByType.ID)},
        public static Button NavigatorPlatformWorktimeButton = GetControl<Button>(JazzControlLocatorKey.ButtonNavigatorPlatformWorktime);//{NavigationTarget.PlatformWorktime, new NavigatorItem(NavigationTarget.PlatformWorktime,NavigationTarget.PlatformSettings,"st-menu-worktime-btnInnerEl",ByType.ID)},
        public static Button NavigatorPlatformSeasonButton = GetControl<Button>(JazzControlLocatorKey.ButtonNavigatorPlatformSeason);//{NavigationTarget.PlatformSeason, new NavigatorItem(NavigationTarget.PlatformSeason,NavigationTarget.PlatformSettings,"st-menu-coldwarm-btnEl",ByType.ID)},
        public static Button NavigatorPlatformDaynightButton = GetControl<Button>(JazzControlLocatorKey.ButtonNavigatorPlatformDaynight);//{NavigationTarget.PlatformDaynight, new NavigatorItem(NavigationTarget.PlatformDaynight,NavigationTarget.PlatformSettings,"st-menu-daynight-btnEl",ByType.ID)},
        public static Button NavigatorPlatformCarbonButton = GetControl<Button>(JazzControlLocatorKey.ButtonNavigatorPlatformCarbon);//{NavigationTarget.PlatformCarbon, new NavigatorItem(NavigationTarget.PlatformCarbon,NavigationTarget.PlatformSettings,"st-menu-carbon-btnEl",ByType.ID)},
        public static Button NavigatorPlatformPriceButton = GetControl<Button>(JazzControlLocatorKey.ButtonNavigatorPlatformPrice);//{NavigationTarget.PlatformPrice, new NavigatorItem(NavigationTarget.PlatformPrice,NavigationTarget.PlatformSettings,"st-menu-price-btnEl",ByType.ID)},
        //--Tag
