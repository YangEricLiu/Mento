...
namespace Mento.Script.Administration.TOU
{
    ...
    public class TOUBasicTariffModifyValidSuite : TestSuiteBase
    {
        ...
        #region TestCase1 ModifyBasicFields
        /// <summary>
        /// Pre-condition: Prepare a TOU with name '价格ForModify名称有效', make sure it has been used by a hierarchy node.
        /// </summary>
        [Test]
        [ManualCaseID("TC-J1-FVT-TOUTariffSetting-Modify-101")]
        [CaseID("TC-J1-FVT-TOUTariffSetting-Modify-101")]
        [Priority("2")]
        [MultipleTestDataSource(typeof(TOUBasicTariffData[]), typeof(TOUBasicTariffModifyValidSuite), "TC-J1-FVT-TOUTariffSetting-Modify-101")]
        public void ModifyBasicFields(TOUBasicTariffData testData)
        {
        ...
        #region TestCase2 ModifyComplexedTimeRanges
        /// <summary>
        /// Pre-condition: Prepare a TOU with name '价格ForModify时间', make sure it has been used by a hierarchy node.
        /// </summary>
        [Test]
        [ManualCaseID("TC-J1-FVT-TOUTariffSetting-Modify-102")]
        [CaseID("TC-J1-FVT-TOUTariffSetting-Modify-102")]
        [Priority("2")]
        [MultipleTestDataSource(typeof(TOUBasicTariffData[]), typeof(TOUBasicTariffModifyValidSuite), "TC-J1-FVT-TOUTariffSetting-Modify-102")]
        ...
        #region TestCase3 ModifyWithEmptyItemNotDisplay
        [Test]
        [ManualCaseID("TC-J1-FVT-TOUTariffSetting-Modify-103")]
        [CaseID("TC-J1-FVT-TOUTariffSetting-Modify-103")]
        [Priority("2")]
        [MultipleTestDataSource(typeof(TOUBasicTariffData[]), typeof(TOUBasicTariffModifyValidSuite), "TC-J1-FVT-TOUTariffSetting-Modify-103")]
        public void ModifyWithEmptyItemNotDisplay(TOUBasicTariffData testData)
        {
            //Select a TOU, make sure it is not beeing used by any hierarchy node.
            TOUBasicTariffSettings.SelectTOU("价格ForModify时间");
