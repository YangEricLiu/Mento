...
I18N.DateTimeFormat.HighFormat.Hour = '%H点%M分';
I18N.DateTimeFormat.HighFormat.Day = '%m月%d日';
I18N.DateTimeFormat.HighFormat.Week = '%m月%d日';
I18N.DateTimeFormat.HighFormat.Month = '%Y年%m月';
...
I18N.DateTimeFormat.IntervalFormat.Second = 'Y年m月d日 H时i分s秒';
I18N.DateTimeFormat.IntervalFormat.Minute = 'Y年m月d日 H时i分';
I18N.DateTimeFormat.IntervalFormat.Hour = 'Y年m月d日 H时';
I18N.DateTimeFormat.IntervalFormat.Day = 'Y年m月d日';
...
I18N.DateTimeFormat.IntervalFormat.FullDateTime = 'Y年m月d日 H时i分s秒';
...
I18N.Setting.TargetBaseline.InputDatesConflictError = '时间设置冲突！请重新设置。';
...
//I18N.Setting.TargetBaseline.CalculatorWindowTitle = '{0}年度{1}计算值 (##Common.Glossary.UOM##: {2})';

I18N.Setting.TargetBaseline.ClearDateSuccess = '清除成功。';

I18N.Setting.Hierarchy.Label.CreateSubHierarchyBtn = '子层级';
//I18N.Setting.Hierarchy.Label.CreateOrganizationWindowTitle = '##Common.Operation.Create####Common.Glossary.Organization##';
//I18N.Setting.Hierarchy.Label.CreateSiteWindowTitle = '##Common.Operation.Create####Common.Glossary.Site##';
//I18N.Setting.Hierarchy.Label.CreateBuildingWindowTitle = '##Common.Operation.Create####Common.Glossary.Building##';
//I18N.Setting.Hierarchy.Label.CreateAreaWindowTitle = '##Common.Operation.Create####Common.Glossary.Area##';
//I18N.Setting.Hierarchy.Label.CreateMeterWindowTitle = '##Common.Operation.Create####Common.Glossary.Meter##';
//I18N.Setting.Hierarchy.Label.CreateTagWindowTitle = '##Common.Operation.Create####Common.Glossary.Tag##';

//I18N.Setting.Hierarchy.Label.UpdateOrganizationWindowTitle = '##Common.Operation.Update####Common.Glossary.Organization##';
//I18N.Setting.Hierarchy.Label.UpdateSiteWindowTitle = '##Common.Operation.Update####Common.Glossary.Site##';
//I18N.Setting.Hierarchy.Label.UpdateBuildingWindowTitle = '##Common.Operation.Update####Common.Glossary.Building##';
//I18N.Setting.Hierarchy.Label.UpdateAreaWindowTitle = '##Common.Operation.Update####Common.Glossary.Area##';
//I18N.Setting.Hierarchy.Label.UpdateMeterWindowTitle = '##Common.Operation.Update####Common.Glossary.Meter##';
//I18N.Setting.Hierarchy.Label.UpdateTagWindowTitle = '##Common.Operation.Update####Common.Glossary.Tag##';

//I18N.Setting.Hierarchy.Label.DeleteOrganizationWindowTitle = '##Common.Operation.Delete####Common.Glossary.Organization##';
//I18N.Setting.Hierarchy.Label.DeleteSiteWindowTitle = '##Common.Operation.Delete####Common.Glossary.Site##';
//I18N.Setting.Hierarchy.Label.DeleteBuildingWindowTitle = '##Common.Operation.Delete####Common.Glossary.Building##';
...
I18N.Setting.TOUTariff.PriceErr = '电价必须大于0';
...
I18N.Setting.TOUTariff.PulsePeakDateTimeCoverErr = '日期时间有叠加，请检查';
I18N.Setting.TOUTariff.PulsePeakDateTimeNullErr = '请配置峰值季节时间';
I18N.Setting.TOUTariff.DateTimeInputErr = '时间输入有误，结束时间必须大于开始时间';
I18N.Setting.TOUTariff.CommonDateTimeInputErr = '时间输入有误，请检查';
...
I18N.Setting.TagAssociation.ConfirmUnassociate = '即将解除所选数据点的关联关系，确认吗？';
...
I18N.EM.SystemDimension.UncheckNodeQuestion = '当前结点下的所有数据点和关键能效指标将被解关联，确认继续？';
I18N.EM.CompareTagsAreFull = '对比数据点已选满，请删除后重新选取';
I18N.EM.MultiTimeCompare = '正在进行多时间段对比，请删除该数据点后重新选取';


I18N.Dashboard.HomePage = '用户首页##Common.Glossary.Dashboard##';
I18N.Dashboard.HierarchyDefault = '默认##Common.Glossary.Dashboard##';
...
I18N.Dashboard.Label.ChangedSaveQuestion = '##Common.Glossary.Dashboard##内容已经变更，您可以保存此更改。';
I18N.Dashboard.WidgetSaveWindowTitle = '添加##Common.Glossary.Widget##至##Common.Glossary.Dashboard##';
I18N.Dashboard.OriginalDashboardsTitle = '已建##Common.Glossary.Dashboard##';
I18N.Dashboard.Add = '添加';
I18N.Dashboard.To = '到:';
I18N.Dashboard.ToNewDashboard = '至新仪表盘';
I18N.Dashboard.NeedChooseDashboard = '请先选择一个仪表盘';
...
I18N.Common.Label.UnknownError = '发生未知错误.';
...
I18N.Common.Label.EmptyData = '没有数据';
I18N.Common.Label.Filters = '查找';

I18N.Common.Label.ConfirmDelete = '确认删除{0}？';
...
I18N.Common.Label.AddressRegexError = '地址只能由汉字，半角英文字母, 数字,下划线、空格和连字符组成。';
I18N.Common.Label.EmailRegexError = '示例：abc.123-def@schneider-electric.com';
I18N.Common.Label.TelephoneRegexError = '电话只能由数字和连字符组成，且不能以连字符开头或结尾, 多个连字符不能连续。';
I18N.Common.Label.UserNameRegexError = '用户名只能由半角英文字母，数字和下划线组成。';
I18N.Common.Label.RealNameRegexError = '用户姓名只能由汉字组成。';
I18N.Common.Label.CustomerNameRegexError = '客户名称只能由汉字和数字组成。';

I18N.Common.Label.CommoEmptyText = '请选择';
I18N.Common.Label.MandatoryEmptyError = '该输入项为必输项';
I18N.Common.Label.WidgetNameRepeated = '##Common.Glossary.Widget##名称重复。';
I18N.Common.Label.WidgetOverBalance = '该##Common.Glossary.Dashboard##已满';
I18N.Common.Label.UnspecifyCommodity = '不指定##Common.Glossary.Commodity##';

I18N.Common.DateRange.Latest7Day = '最近7天';
...
I18N.Common.GraphType.Line = '曲线图';
I18N.Common.GraphType.Column = '柱状图';
I18N.Common.GraphType.Pie = '饼图';
I18N.Common.GraphType.GridView = '数据表';
...
I18N.Common.Glossary.HierarchyNode = '层级结点';
I18N.Common.Glossary.HierarchyTree = '层级结构';
I18N.Common.Glossary.Dimension = '维度';
I18N.Common.Glossary.DimensionNode = '维度结点';
...
I18N.Message.M01010 = '##Common.Glossary.Hierarchy##的##Common.Glossary.Name##重复，无法保存。';
I18N.Message.M01011 = '父节点可能已经被删除，无法保存。';
I18N.Message.M01012 = '该节点包含其他子节点，无法删除。';
I18N.Message.M01013 = '未指定##Common.Glossary.Hierarchy##的父节点，无法保存。';
I18N.Message.M01014 = '该节点已被其他用户修改或删除，层级树将被刷新。';
I18N.Message.M01016 = '相关的##Common.Glossary.Hierarchy##无有效日历';
I18N.Message.M01051 = '相关的层级树节点已被删除，无法保存。层级树将被刷新。';
...
//I18N.Message.M01021 = '##Message.M01008##';
//I18N.Message.M01024 = '##Message.M01001##';
...
//I18N.Message.M01032 = '该##Common.Glossary.Tag##下已有能源数据，无法删除。';
...
I18N.Message.M02006 = '节点ID为空';
I18N.Message.M02007 = '开始时间不能大于结束时间';
I18N.Message.M02008 = '当前##Common.Glossary.VirtualTag##的类型不是测量数据类型，无法生成饼图';
I18N.Message.M02009 = '##Common.Glossary.PhysicalTag##无法生成饼图';
I18N.Message.M02013 = '##Common.Glossary.VirtualTag##不存在';
...
I18N.Message.M02112 = '数据点非测量值，无法转换';
I18N.Message.M02113 = '非法数据点，无法转换';
I18N.Message.M02114 = '数据点无法转换为统一单位';

I18N.Message.M02203 = '关键能效指标不存在';

I18N.Message.M02301 = '层级节点不存在';
I18N.Message.M02302 = '层级节点总能耗数据点不唯一';
//for energy view single tag to pie chart
I18N.Message.M01015 = '当前层级节点无子节点';
I18N.Message.M04055 = '当前系统维度节点无子节点';
I18N.Message.M08214 = '当前区域维度节点无子节点';
...
*/
I18N.Message.M08208 = '当前的##Common.Glossary.DimensionNode##的##Common.Glossary.Name##重复，无法保存';
I18N.Message.M08209 = '当前的##Common.Glossary.DimensionNode##的级次超出最大长度，无法保存';
I18N.Message.M08210 = '当前的##Common.Glossary.DimensionNode##的父节点已被删除';
I18N.Message.M08200 = '关联##Common.Glossary.DimensionNode##的##Common.Glossary.HierarchyNode##已被删除，界面将被刷新';
I18N.Message.M08211 = '当前的##Common.Glossary.DimensionNode##已被他人删除';
I18N.Message.M08212 = '当前的##Common.Glossary.DimensionNode##存在子节点';
I18N.Message.M08213 = '当前的##Common.Glossary.DimensionNode##已被他人修改，界面将被刷新';


I18N.Message.M09105 = '工作日/非工作日信息为空，无法保存';
I18N.Message.M09107 = '数据已被他人修改，点击‘确定’开始重新加载数据';
I18N.Message.M09112 = '关联的##Common.Glossary.VirtualTag##已被删除，界面将被刷新';
I18N.Message.M09113 = '未设置计算规则，不能计算';
...
I18N.Message.M03027 = '价格策略为空';
I18N.Message.M03028 = '价格策略不存在';
I18N.Message.M03029 = '峰值季节不存在';
I18N.Message.M03030 = '价格策略时间区间错误';
I18N.Message.M03031 = '价格策略至少包含一个平时价格配置';
I18N.Message.M03032 = '价格策略时间区间验证失败';
I18N.Message.M03033 = '价格策略必须包含峰时电价和谷时电价';
I18N.Message.M03034 = '峰值季节时间区间为空';
I18N.Message.M03035 = '峰值季节时间区间重叠';
I18N.Message.M03036 = '峰值季节为空';
I18N.Message.M03038 = '价格策略已被引用，不可修改或删除';
I18N.Message.M03039 = '峰值季节时间区间为空';
I18N.Message.M03040 = '价格策略名称已存在';
...
I18N.Message.M05001 = '已存在同名的##Common.Glossary.Dashboard##，请修改##Common.Glossary.Dashboard##的名称后再继续保存，当前操作失败';
I18N.Message.M05002 = '该##Common.Glossary.Dashboard##已被他人修改，界面将被刷新';
I18N.Message.M05003 = '该##Common.Glossary.Dashboard##保存时传入参数为空，无法保存';
I18N.Message.M05004 = '该##Common.Glossary.Dashboard##的名字不能为空，无法保存';
I18N.Message.M05005 = '该##Common.Glossary.Dashboard##的名字长度超出系统范围，无法保存';
I18N.Message.M05006 = '该##Common.Glossary.Dashboard##的名字存在系统无效字符，无法保存';
I18N.Message.M05007 = '该##Common.Glossary.Dashboard##的Id是非法值，无法保存';
I18N.Message.M05008 = '该##Common.Glossary.Dashboard##的Version是非法值，无法保存';
I18N.Message.M05009 = '该##Common.Glossary.Dashboard##关联的##Common.Glossary.HierarchyNode##的Id是非法值，无法保存';
I18N.Message.M05010 = '该##Common.Glossary.Dashboard##关联的##Common.Glossary.User##的Id是非法值，无法保存';
I18N.Message.M05011 = '当前的##Common.Glossary.HierarchyNode##已经被删除，界面将被刷新';
I18N.Message.M05013 = '当前的##Common.Glossary.HierarchyNode##的##Common.Glossary.Dashboard##数量已达上限';
...
//I18N.Message.M06101 = '##Common.Glossary.PhysicalTag##的ID非法，无法保存。';
...
//I18N.Message.M06118 = '##Common.Glossary.VirtualTag##的值为空，无法保存。';
//I18N.Message.M06119 = '##Common.Glossary.VirtualTag##的ID非法，无法保存。';
//I18N.Message.M06120 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Name##不能为空，无法保存。';
//I18N.Message.M06121 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Name##超过最大长度限制，无法保存。';
...
//I18N.Message.M06132 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Formula##不能为空，无法保存。';
I18N.Message.M06133 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Formula##非法，无法保存。';
I18N.Message.M06134 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Formula##包含非法的##Common.Glossary.Tag##。';
I18N.Message.M06135 = '##Common.Glossary.VirtualTag##';
I18N.Message.M06136 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Formula##包含循环调用，无法保存。';
//I18N.Message.M06137 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Dimension##不能为空，无法保存。';
//I18N.Message.M06138 = '##Common.Glossary.VirtualTag##';
//I18N.Message.M06139 = '该##Common.Glossary.VirtualTag##已被其他用户修改或删除，界面将被刷新。';
//I18N.Message.M06140 = '该##Common.Glossary.System####Common.Glossary.Dimension##的ID非法，无法获取数据。';
I18N.Message.M06141 = '##Common.Glossary.System####Common.Glossary.Dimension##不存在或已被其他用户删除，界面将被刷新。';
//I18N.Message.M06142 = '该##Common.Glossary.Area####Common.Glossary.Dimension##的ID非法，无法获取数据。';
I18N.Message.M06143 = '##Common.Glossary.Area####Common.Glossary.Dimension##不存在或已被其他用户删除，界面将被刷新。';
//I18N.Message.M06144 = '##Common.Glossary.Customer##的ID非法，无法保存。';
//I18N.Message.M06145 = '##Common.Glossary.Customer##不存在或已被其他用户删除，界面将被刷新。';
//I18N.Message.M06146 = '##Common.Glossary.VirtualTag##的##Common.Glossary.UOM##的ID非法，无法保存。';
//I18N.Message.M06147 = '##Common.Glossary.VirtualTag##的##Common.Glossary.UOM##不存在或已被其他用户删除，无法保存。';
//I18N.Message.M06148 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Commodity##的ID非法，无法保存。';
//I18N.Message.M06151 = '##Common.Glossary.PhysicalTag##的##Common.Glossary.Name##非法，无法保存。';
//I18N.Message.M06152 = '该##Common.Glossary.PhysicalTag##已被其他用户删除，界面将被刷新。';
//I18N.Message.M06153 = '##Common.Glossary.PhysicalTag##';
//I18N.Message.M06154 = '该##Common.Glossary.VirtualTag##已被其他用户删除，界面将被刷新。';
//I18N.Message.M06155 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Name##非法，无法保存。';
I18N.Message.M06156 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Formula##包含非法的##Common.Glossary.Tag##，无法保存。';
//I18N.Message.M06157 = '##Common.Glossary.Customer##的ID非法，无法获取数据。';
//I18N.Message.M06158 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Comment##超过最大长度限制，无法保存。';
//I18N.Message.M06159 = '##Common.Glossary.PhysicalTag##的##Common.Glossary.Comment##超过最大长度限制，无法保存。';
...
//I18N.Message.M06163 = '##Common.Glossary.VirtualTag##的##Common.Glossary.CalculationType##非法，无法保存。';
I18N.Message.M06164 = '##Common.Glossary.VirtualTag##的##Common.Glossary.CalculationStep##非法，无法保存。';
//I18N.Message.M06165 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Type##非法，无法保存。';
//I18N.Message.M06166 = '##Common.Glossary.PhysicalTag##的##Common.Glossary.Type##非法，无法保存。';
//I18N.Message.M06167 = '##Common.Glossary.PhysicalTag##的##Common.Glossary.CalculationType##非法，无法保存。';
//I18N.Message.M06170 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Type##非法，无法保存。';
//I18N.Message.M06175 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Type##非法，无法保存。';
I18N.Message.M06174 = '##Common.Glossary.PhysicalTag##的##Common.Glossary.Type##非法，无法保存。';
//I18N.Message.M06176 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Type##非法，无法保存。';
//I18N.Message.M06181 = '##Common.Glossary.VirtualTag##的##Common.Glossary.Type##非法，无法保存。';
//I18N.Message.M06182= '无法将{0}标记为能耗数据点！已存在相同介质的能耗数据点！';
I18N.Message.M06183 = '##Common.Glossary.Tag##已经过期，可能该##Common.Glossary.Tag##已被他人修改或删除。界面即将刷新。';
//I18N.Message.M06184 = '无法将{0}标记为能耗数据点！已存在相同介质的能耗数据点！';
//I18N.Message.M06185 = '##Common.Glossary.Tag##已经过期，可能该##Common.Glossary.Tag##已被他人修改或删除。界面即将刷新。';
...
I18N.Message.M06304 = '此##Common.Glossary.Tag##不是能耗数据';
//auth
I18N.Auth = {};
I18N.Auth.Label = {};
I18N.Auth.Message = {};
...
I18N.Auth.Message.PasswordRegexError = '密码只能由半角英文字母, 数字,下划线和 !, @, #, $, %, ^, &, *, (, ) 组成，且必须包含数字与字母。';
I18N.Auth.Message.UserValidationError = '用户名密码不匹配。';
...
I18N.Setting.Hierarchy.Message.PopulationReduplicate = '人口属性重复。';
...
I18N.Message.M01251 = '该属性已被其他用户修改，值将被刷新。';
I18N.Message.M01252 = '属性为空，无法保存。';
I18N.Message.M01254 = '属性非法，无法保存。';

//carbon factor
I18N.Common.Glossary.CarbonFactor = '转换因子';

I18N.Setting.CarbonFactor = {};
I18N.Setting.CarbonFactor.Label = {};

I18N.Setting.CarbonFactor.Label.StartYear = '起始年份';
I18N.Setting.CarbonFactor.Label.Factor = '转换率';
I18N.Setting.CarbonFactor.Label.CreateFactor = '添加##Common.Glossary.CarbonFactor##';
I18N.Setting.CarbonFactor.Label.CreateFactorProperty = '##Common.Glossary.CarbonFactor##属性';
I18N.Setting.CarbonFactor.Label.To = '对';

I18N.Common.Label.PositiveRegexError = '该输入项只能是正数。';

I18N.Message.M03005 = '##Common.Glossary.CarbonFactor##重复。';
I18N.Message.M03006 = '该##Common.Glossary.CarbonFactor##已被其他用户删除。';
I18N.Message.M03007 = '该##Common.Glossary.CarbonFactor##已被其他用户修改。';

//calendar
I18N.Setting.Label.CalendarBasicProperties = '##Setting.Label.BasicProperties##';
I18N.Setting.Label.WorkDay = '工作日';
I18N.Setting.Label.Holiday = '非工作日';
I18N.Setting.Label.WorkTime = '工作时间';
I18N.Setting.Label.RestTime = '休息时间';
I18N.Setting.Label.Day = '白昼';
I18N.Setting.Label.Night = '黑夜';
I18N.Setting.Label.WarmSeason = '采暖季';
I18N.Setting.Label.ColdSeason = '供冷季';
I18N.Setting.Label.StartDate = '开始日期';
I18N.Setting.Label.EndDate = '结束日期';
I18N.Setting.Label.StartTime = '开始时间';
I18N.Setting.Label.EndTime = '结束时间';
I18N.Setting.Label.Month = '月份';
I18N.Setting.Label.Day = '日期';

I18N.Message.M03051 = '时间段不能为空！';
I18N.Message.M03052 = '结束日期必须大于等于开始日期！';
I18N.Message.M03053 = '日期/时间不能重叠！';
I18N.Message.M03054 = '日历名称重复！';
I18N.Message.M03055 = '日历已被删除！';
I18N.Message.M03056 = '日历已被修改！';
I18N.Message.M03057 = '结束时间必须大于开始时间！';
I18N.Message.M03058 = '日历已经被引用，禁止修改/删除！';
I18N.Message.M03059 = '二月日期不能为29/30/31！';
I18N.Message.M03060 = '小月日期不能为31！';
I18N.Message.M03061 = '采暖季与供冷季时间段均不能为空！';
I18N.Message.M03062 = '采暖季与供冷季时间段不能在同一月份内！';
I18N.Message.M03063 = '采暖季与供冷季时间段相差不能小于7天！';
I18N.Message.M03064 = '层级节点已被其他用户删除，界面将刷新！';

//hiearchy calendar
I18N.Message.M01301 = '日历已被修改！';
I18N.Message.M01302 = '日历已经创建！';
I18N.Message.M01303 = '日历不能为空！';
...
I18N.Setting.Label.Uploading = '正在上传...';

I18N.Message.LogoIsEmpty = '请上传Logo！';
I18N.Message.M11351 = '客户编码重复！';
I18N.Message.M11352 = '客户名称重复！';
I18N.Message.M11353 = '客户信息已被其他用户修改，界面将被刷新！';
I18N.Message.M11354 = '图片文件太大，上传失败！请重新上传。';
I18N.Message.M11355 = '图片尺寸太大，上传失败！请重新上传。';
I18N.Message.M11356 = '只允许上传GIF/PNG格式图片！请重新上传。';
I18N.Message.M11357 = '客户信息已被其他用户删除，界面将被刷新！';
I18N.Message.M11358 = '客户已被其他数据引用，不能删除！';
I18N.Message.M11359 = '客户电子邮件输入错误！';
I18N.Message.M11360 = '客户电话输入错误！';
I18N.Message.M11361 = '客户运营时间输入错误！';

I18N.Message.M11012 = '该客户被层级引用，不能删除！';
I18N.Message.M11401 = '该客户被系统维度引用，不能删除！';
I18N.Message.M11402 = '该客户被区域维度引用，不能删除！';
I18N.Message.M11403 = '该客户被仪表盘引用，不能删除！';
I18N.Message.M11404 = '该客户被用户引用，不能删除！';
I18N.Message.M11405 = '该客户被日历引用，不能删除！';
I18N.Message.M11406 = '该客户被成本引用，不能删除！';
I18N.Message.M11407 = '该客户被高级属性引用，不能删除！';
I18N.Message.M11408 = '该客户被数据点引用，不能删除！';

//user
I18N.Setting.Label.UserManagement = '用户管理';
I18N.Setting.Label.UserName = '用户名';
I18N.Setting.Label.RealName = '用户姓名';
I18N.Setting.Label.MembershipCustomer = '所属客户';
I18N.Setting.Label.Title = '职务';
I18N.Setting.Label.CreatePasswrod = '生成密码';
I18N.Setting.Label.AllCustomers = '全部客户';

I18N.Message.M12001 = '用户名重复！';
I18N.Message.M12002 = '用户信息已被其他用户修改，界面将被刷新！';
I18N.Message.M12003 = '当前密码输入错误！';
I18N.Message.M12004 = '所属客户信息错误！';
I18N.Message.M12005 = '所属客户已被其他用户修改，界面将刷新！';
I18N.Message.M12006 = '默认平台管理员禁止删除！';
I18N.Message.M12007 = '该客户已存在客户管理员！';
I18N.Message.M12008 = '用户已被其他用户删除，界面将刷新！';
I18N.Message.M12009 = '用户不能删除自身！';
I18N.Message.M12010 = '用户不能重置自身密码！';
I18N.Message.M12011 = '用户只能修改自身密码！';
I18N.Message.RandomPassword = '随机登录密码：';

//user profile
I18N.Setting.Label.ViewPersonalInfo = '查看个人信息';
I18N.Setting.Label.ViewCustomerInfo = '查看客户信息';
I18N.Setting.Label.ChangePassword = '修改密码';
I18N.Setting.Label.Logout = '退出系统';
I18N.Setting.Label.OriginalPassword = '当前密码';
I18N.Setting.Label.NewPassword = '新密码';
I18N.Setting.Label.ConfirmPassword = '确认新密码';
I18N.Setting.Label.PersonalInfo = '个人资料';
I18N.Setting.Label.PasswordTip = '密码需同时包含字母及数字，并不少于8位字符。不支持空格。';

I18N.Message.ResetPasswordSuccess = '密码已成功修改，请重新登录。';
I18N.Message.ConfirmPasswordWrong = '两次输入的新密码不一致！';
I18N.Message.QuiteQuery = '退出系统？';

//usertype
I18N.Setting.Label.UserType = '用户权限类型';

I18N.Setting.Label.HomePage = '首页';
I18N.Setting.Label.DashboardView = '仪表盘与组件查看';

I18N.Setting.Label.UserInfo = '用户信息';
I18N.Setting.Label.DashBoradManagement = '仪表盘管理';
I18N.Setting.Label.WidgetManagement = '组件管理';

I18N.Setting.Label.EnergyEfficiency = '能效展示';

I18N.Setting.Label.Customization = '客户自定义';
I18N.Setting.Label.SystemDimensionConfiguration = '系统维度配置';
I18N.Setting.Label.AreaDimensionConfiguration = '区域维度配置';
I18N.Setting.Label.KPIConfiguration = '关键能效指标配置';
I18N.Setting.Label.TagMapping = '数据匹配';
I18N.Setting.Label.CalendarConfiguration = '日历配置';
I18N.Setting.Label.CustomerConfiguration = '客户配置';

I18N.Message.M13002 = '功能权限已被其他用户修改，界面将被刷新！';
I18N.Message.M13003 = '功能权限超出允许的范围！';
I18N.Message.M13004 = '用户权限不可为空，请选择！';
I18N.Message.M13005 = '用户权限必须包含仪表盘与组件查看、用户信息，请选择！';