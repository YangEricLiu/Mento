...
namespace Mento.Script.Administration.BasicIndustryAndZoneVerify
{
    [TestFixture]
    [Owner("Cathy")]
    ...
    public class BasicIndustryAndZoneSettingSuite : TestSuiteBase
    {
        ...
        [CaseID("TC-J1-FVT-BasicIndustryAndZoneSetting-View-101"), Owner("Cathy"), CreateTime("2014-9-29")]
        [Priority("4")]
