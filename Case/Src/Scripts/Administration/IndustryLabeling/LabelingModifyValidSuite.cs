...
namespace Mento.Script.Administration.IndustryLabeling
{
    ...
    public class LabelingModifyValidSuite : TestSuiteBase
    {
        ...
        [Priority("4")]
        [MultipleTestDataSource(typeof(IndustryLabelingData[]), typeof(LabelingModifyInvalidSuite), "TC-J1-FVT-IndustrylabelingSetting-Modify-101")]
        public void ModifyIndustryLabelingValid(IndustryLabelingData input)
        {
            ...
            Assert.IsTrue(IndustryLabelingSetting.IsClimateRegionComboxEnabled());
            ...
            //· The 行业=酒店 and  气候分区=严寒地区A区  display  and not editable.
            Assert.IsFalse(IndustryLabelingSetting.IsIndustryComboxEnabled());
