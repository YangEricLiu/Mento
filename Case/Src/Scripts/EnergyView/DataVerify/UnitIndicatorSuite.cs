...
namespace Mento.Script.EnergyView.DataVerify
{
    ...
    /// </summary>
    [TestFixture]
    [ManualCaseID("TC-J1-FVT-UN-DataVerify-101"), CreateTime("2015-10-13"), Owner("Emma")]
    public class UnitIndicatorSuite : TestSuiteBase
    {
        ...
        [Test]
        [Category("P1_Emma")]
        [CaseID("TC-J1-FVT-UN-EA-DataVerify-101-1")]
        [MultipleTestDataSource(typeof(EnergyAnalysisData[]), typeof(UnitIndicatorSuite), "TC-J1-FVT-UN-EA-DataVerify-101-1")]
        public void UN_EA_DataVerify(EnergyAnalysisData input)
        {
            //选择图表
        ...
        [Test]
        [Category("P3_Emma")]
        [CaseID("TC-J1-FVT-UN-Cost-DataVerify-101-1")]
        [MultipleTestDataSource(typeof(EnergyAnalysisData[]), typeof(UnitIndicatorSuite), "TC-J1-FVT-UN-Cost-DataVerify-101-1")]
        public void UN_Cost_DataVerify(EnergyAnalysisData input)
        {
            //选择图表
            FolderWidget.NewJazz_SelectFolderOrWidget(input.InputData.WidgetPath);
            TimeManager.Pause(30000);
        ...
        [Test]
        [Category("P3_Emma")]
        [CaseID("TC-J1-FVT-UN-Carbon-DataVerify-101-1")]
        [MultipleTestDataSource(typeof(EnergyAnalysisData[]), typeof(UnitIndicatorSuite), "TC-J1-FVT-UN-Carbon-DataVerify-101-1")]
        public void UN_Carbon_DataVerify(EnergyAnalysisData input)
        {
            //选择图表
            FolderWidget.NewJazz_SelectFolderOrWidget(input.InputData.WidgetPath);
            TimeManager.Pause(30000);
