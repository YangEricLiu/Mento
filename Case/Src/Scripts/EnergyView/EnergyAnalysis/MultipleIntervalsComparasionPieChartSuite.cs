...
namespace Mento.Script.EnergyView.EnergyAnalysis
{
    ...
    public class MultipleIntervalsComparasionPieChartSuite : TestSuiteBase
    {
        ...
        public void ViewSingleTagPiechartAndSaveToDashboard(TimeSpansData input)
        {
            ...
            ////Click 'X' to remove a compared span from legend area. And check the deletion is successful:
            //EnergyAnalysis.ClosePieLegendItem(1);//Can't find the element(pie chart legend close button)
            //Assert.AreEqual(4, EnergyAnalysis.GetPieChartSpans());
            //Assert.AreEqual(4, EnergyAnalysis.GetPieChartShowSpans());
            //EnergyAnalysis.ClosePieLegendItem(0);
            //Assert.AreEqual(3, EnergyAnalysis.GetPieChartSpans());
            //Assert.AreEqual(3, EnergyAnalysis.GetPieChartShowSpans());
