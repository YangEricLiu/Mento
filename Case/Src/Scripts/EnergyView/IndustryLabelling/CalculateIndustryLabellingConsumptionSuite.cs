...
namespace Mento.Script.EnergyView.IndustryLabelling
{
    ...
    public class CalculateIndustryLabellingConsumptionSuite : TestSuiteBase
    {
        [SetUp]
        ...
        [MultipleTestDataSource(typeof(IndustryLabellingData[]), typeof(CalculateIndustryLabellingConsumptionSuite), "TC-J1-FVT-ConsumptionUnitIndicatorIndustryLabelling-Calculate-101-1")]
        ...
        [MultipleTestDataSource(typeof(IndustryLabellingData[]), typeof(CalculateIndustryLabellingConsumptionSuite), "TC-J1-FVT-ConsumptionUnitIndicatorIndustryLabelling-Calculate-101-2")]
        ...
        [MultipleTestDataSource(typeof(IndustryLabellingData[]), typeof(CalculateIndustryLabellingConsumptionSuite), "TC-J1-FVT-ConsumptionUnitIndicatorIndustryLabelling-Calculate-101-3")]
