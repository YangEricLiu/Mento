...
namespace Mento.Script.EnergyView.IndustryLabelling
{
    ...
    /// </summary>
    [TestFixture]
    [ManualCaseID("TC-J1-FVT-ConsumptionWorkNotworkRatioIndustryLabelling-View-101"), CreateTime("2014-03-04"), Owner("Emma")]
    public class ViewIndustryLabellingWorkNotworkSuite : TestSuiteBase
    {
        [SetUp]
        ...
        [Test]
        [CaseID("TC-J1-FVT-ConsumptionWorkNotworkRatioIndustryLabelling-View-101-1")]
        [MultipleTestDataSource(typeof(IndustryLabellingData[]), typeof(ViewIndustryLabellingWorkNotworkSuite), "TC-J1-FVT-ConsumptionWorkNotworkRatioIndustryLabelling-View-101-1")]
        public void ViewWorkNotworkIndustryLabelling01(IndustryLabellingData input)
        {
        ...
        [Test]
        [CaseID("TC-J1-FVT-ConsumptionWorkNotworkRatioIndustryLabelling-View-101-2")]
        [MultipleTestDataSource(typeof(IndustryLabellingData[]), typeof(ViewIndustryLabellingWorkNotworkSuite), "TC-J1-FVT-ConsumptionWorkNotworkRatioIndustryLabelling-View-101-2")]
        public void ViewWorkNotworkIndustryLabelling02(IndustryLabellingData input)
        {
            //Go to NancyOtherCustomer3. Go to Function Labelling view. 
            HomePagePanel.SelectCustomer("NancyOtherCustomer3");
            TimeManager.ShortPause();
            ...
            //Select the BuildingMultipleSteps from Hierarchy Tree, select 公休比 option
        ...
        [Test]
        [CaseID("TC-J1-FVT-ConsumptionWorkNotworkRatioIndustryLabelling-View-101-3")]
        [MultipleTestDataSource(typeof(IndustryLabellingData[]), typeof(ViewIndustryLabellingWorkNotworkSuite), "TC-J1-FVT-ConsumptionWorkNotworkRatioIndustryLabelling-View-101-3")]
        public void ViewWorkNotworkIndustryLabelling03(IndustryLabellingData input)
        {
            //Go to NancyOtherCustomer3. Go to Function Labelling view.  
            HomePagePanel.SelectCustomer("NancyOtherCustomer3");
            TimeManager.ShortPause();
            ...
            //select a 行业区域=夏热冬暖酒店三星级行业; Go to 公休比 option, time range=2012/10 to view chart.
            EnergyViewToolbar.SelectLabellingUnitTypeConvertTarget(input.InputData.UnitTypeValue);
            EnergyViewToolbar.SelectLabellingIndustryConvertTarget(input.InputData.Industries[0]);
            IndustryLabellingPanel.SetYear(input.InputData.YearAndMonth[0].year);
            IndustryLabellingPanel.SetMonth(input.InputData.YearAndMonth[0].month);
