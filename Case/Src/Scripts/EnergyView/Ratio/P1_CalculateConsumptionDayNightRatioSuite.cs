...
namespace Mento.Script.EnergyView.Ratio
{
    ...
    public class P1_CalculateConsumptionDayNightRatioSuite : TestSuiteBase
    {
        [SetUp]
        ...
        [MultipleTestDataSource(typeof(RatioData[]), typeof(P1_CalculateConsumptionDayNightRatioSuite), "TC-J1-FVT-ConsumptionDayNightRatio-Calculate-101-1")]
        ...
        [MultipleTestDataSource(typeof(RatioData[]), typeof(P1_CalculateConsumptionDayNightRatioSuite), "TC-J1-FVT-ConsumptionDayNightRatio-Calculate-101-2")]
