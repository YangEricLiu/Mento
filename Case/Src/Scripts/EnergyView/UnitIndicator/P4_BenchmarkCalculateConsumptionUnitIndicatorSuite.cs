...
namespace Mento.Script.EnergyView.UnitIndicator
{
    ...
    /// </summary>
    [TestFixture]
    [ManualCaseID("TC-J1-FVT-BenchmarkConsumptionUnitIndicator-Calculate-101"), CreateTime("2013-12-16"), Owner("Emma")]
    public class P4_BenchmarkCalculateConsumptionUnitIndicatorSuite : TestSuiteBase
    {
        ...
        [MultipleTestDataSource(typeof(UnitIndicatorData[]), typeof(P4_BenchmarkCalculateConsumptionUnitIndicatorSuite), "TC-J1-FVT-BenchmarkConsumptionUnitIndicator-Calculate-101-1")]
        public void BenckmarkCalculateConsumptionUnitIndicator01(UnitIndicatorData input)
        {
            ...
            //time range 2012-11-20 to 2013-12-5
        ...
        [MultipleTestDataSource(typeof(UnitIndicatorData[]), typeof(P4_BenchmarkCalculateConsumptionUnitIndicatorSuite), "TC-J1-FVT-BenchmarkConsumptionUnitIndicator-Calculate-101-2")]
