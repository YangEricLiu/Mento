...
namespace Mento.Script.EnergyView.UnitIndicator
{
    ...
    public class P4_BenchmarkCalculateCostUnitIndicatorSuite : TestSuiteBase
    {
        [SetUp]
        ...
        [MultipleTestDataSource(typeof(UnitIndicatorData[]), typeof(P4_BenchmarkCalculateCostUnitIndicatorSuite), "TC-J1-FVT-BenckmarkCostUnitIndicator-Calculate-101-1")]
        ...
        [MultipleTestDataSource(typeof(UnitIndicatorData[]), typeof(P4_BenchmarkCalculateCostUnitIndicatorSuite), "TC-J1-FVT-BenckmarkCostUnitIndicator-Calculate-101-2")]
        ...
        [MultipleTestDataSource(typeof(UnitIndicatorData[]), typeof(P4_BenchmarkCalculateCostUnitIndicatorSuite), "TC-J1-FVT-BenckmarkCostUnitIndicator-Calculate-101-3")]
        ...
        [MultipleTestDataSource(typeof(UnitIndicatorData[]), typeof(P4_BenchmarkCalculateCostUnitIndicatorSuite), "TC-J1-FVT-BenckmarkCostUnitIndicator-Calculate-101-4")]
        ...
        [MultipleTestDataSource(typeof(UnitIndicatorData[]), typeof(P4_BenchmarkCalculateCostUnitIndicatorSuite), "TC-J1-FVT-BenckmarkCostUnitIndicator-Calculate-101-5")]
