...
namespace Mento.Script.OpenAPI
{
    ...
    public class EnergyViewAPI : TestSuiteBase
    {
        ...
        private static string pathTestCase = @"E:\OpenAPITest\OpenApi Test Cases_1.9.0.17.xlsx";
        private static string pathCaseResult = @"E:\OpenAPITest\OpenApi Test Cases_1.9.0.17_Result.xlsx";
