...
namespace Mento.Script.OpenAPI
{
    ...
    public class EnergyViewAPI : TestSuiteBase
    {
        ...
        private static string pathTestCase = @"E:\OpenAPITest\OpenApi Test Cases_1.9.1.345.xlsx";
        private static string pathCaseResult = @"E:\OpenAPITest\OpenApi Test Cases_1.9.1.345_Result.xlsx";
