...
I18N.Setting.Label.PowerFactorSetting = '功率因素标准值';
...
I18N.Setting.TOUTariff.BasicPropertyTimeNullMsg = '峰时和谷时配置不能为空';
I18N.Setting.TOUTariff.BasicPropertyErrMsg = '时间输入有误，请确认时间范围是否相互覆盖，若未设置平时电价，请确保峰时范围和谷时范围充满24小时';
I18N.Setting.TOUTariff.BasicPropertyErrMsg1 = '结束时间必须大于开始时间';
I18N.Setting.TOUTariff.PulsePeakPrice = '峰值季节电价';
I18N.Setting.TOUTariff.AddPulsePeakDateTime = '添加峰值季节时间';
I18N.Setting.TOUTariff.PulsePeakDateTimeCoverErr = '输入的日期时间和已存在日期时间有叠加，请检查';
I18N.Setting.TOUTariff.PulsePeakDateTimeNullErr = '请配置峰值季节时间';
I18N.Setting.TOUTariff.DateTimeInputErr = '时间输入有误，结束时间不能小于开始时间';
...
I18N.Dashboard.WidgetSaveWindowTitle = '添加至##Common.Glossary.Dashboard##';
...
I18N.Common.Label.HomePage = '主页';
I18N.Common.Label.EnergyService = '能源管理';
I18N.Common.Label.Setting = '设置';
...
I18N.Common.Label.WidgetNameRepeated = 'Widget名称重复。';
I18N.Common.Label.WidgetOverBalance = '该##Common.Glossary.Dashboard##的Widget的数量已达上限。';
I18N.Common.Label.ChannelIDError = '##Common.Glossary.Channel##值只能是正整数。';
...
I18N.Common.Glossary.Widget = '组件';
...
I18N.Common.Glossary.Formula = '公式';
...
I18N.Message.M09113 = '##Message.M09112##';
...
I18N.Message.M05002 = '该##Common.Glossary.Dashboard##已被他人修改，##Common.Glossary.Dashboard##列表将被刷新';
...
I18N.Message.M06100 = '##Common.Glossary.Tag##可能已经被删除或者输入数据为空，无法保存。';
...
I18N.Message.M06192 = '昼夜比##Common.Glossary.Tag##的##Common.Glossary.CalculationStep##必须大于天！';
...
I18N.Auth.Message.PasswordRegexError = '密码只能由半角英文字母, 数字,下划线和 !, @, #, $, %, ^, &, *, (, ) 组成。';
...
I18N.Message.M03005 = '##Common.Glossary.CarbonFactor##重复，列表将被刷新。';
I18N.Message.M03006 = '该##Common.Glossary.CarbonFactor##已被其他用户删除，列表将被刷新。';
I18N.Message.M03007 = '该##Common.Glossary.CarbonFactor##已被其他用户修改，列表将被刷新。';
...
I18N.Message.M03053 = '开始日期与结束日期不能重叠！';
